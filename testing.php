    ...
    <div class="modal-content"> -->
      ...
      <!-- <div class="modal-body">
		<form action = "" method = "post">
			...
			<h5 class="modal-title">Ubah Label</h5>
			<select name="label">
				<option>Semua</option>
				<option value="1" <?= ($_POST['label']=='1') ? 'selected' : ''?>>Transaksi</option>
				<option value="-1" <?= ($_POST['label']=='-1') ? 'selected' : ''?>>Iklan</option>
			</select>
